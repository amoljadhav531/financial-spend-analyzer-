...
public class ValidateServiceImpl implements ValidateService {
	...
	private static final String ACCOUNT_SID = "ACf73ecdd4b";
	private static final String AUTH_ID = "d099b8077232a169";
	...
	public void sendNotification(TransactionDetail transactionDetail) {
		try {
			...
			Message.creator(new PhoneNumber("+91" + transactionDetail.getCustomerDetails().getMobileNumber()), new PhoneNumber("+from No"), msg).create();
		} catch (Exception e) {
			log.error("Error: "+ e);
		}
	}
